...
# INITIALIZE SESSION
TOKEN = post_api_data(f'https://osu.ppy.sh/oauth/token', json={
...
def get_player_profile(username: str = None, user_id: int = None, gamemode: str = 'osu'):
    ...
    return get_api_data(f'https://osu.ppy.sh/api/v2/users/{username if username else user_id}/{gamemode}', headers=HEADERS).json()
